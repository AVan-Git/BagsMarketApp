    ...
    <View style={[styles.flex_1 ,{
      ...
      <ImageBackground  style={[ styles.flex_1,{}]} source={require('../images/img_Start_1.png')}   >
        ...
        <View style={[ styles.flex_2,{
          ...
          <View  style={[ ,{ borderRadius: 30, marginHorizontal: "5%", marginTop: 20,
          backgroundColor: '#c4c4c4'}]} >
            <TouchableOpacity  style={[ styles.row,{ alignItems:'center', justifyContent: 'space-between', margin:8,
              backgroundColor: '#69ff69',
              borderRadius: 30,

          }]} >
              <Text  style={[ ,{fontSize: 18, backgroundColor: '#fff',
                borderRadius: 30,
                padding: 12,
